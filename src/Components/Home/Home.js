                ...
                <div className="row align-items-center">
                    ...
                    <section className="my-resume">
                        <div className="py-1 w3l-resume">
                            <div className="container py-lg-5 py-3">
                                ...
                                <a href="about.html" className="btn btn-style btn-primary mr-3 mt-2 mb-5 float-right">Download CV</a>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="project-details">
                        ...
                        <div className="projects">
                            ...
                            <MyProjects img="./project-images/Shoping-Cart/Shoping-Cart1.png" URL="https://clone-9b4a8.web.app/" title="Shoping-Cart" />
                        </div>
                    </section>
